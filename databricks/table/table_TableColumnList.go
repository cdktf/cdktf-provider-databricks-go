...
import (
	...
	"github.com/hashicorp/cdktf-provider-databricks-go/databricks/v3/table/internal"
...
func (t *jsiiProxy_TableColumnList) Resolve(_context cdktf.IResolveContext) interface{} {
