...
type GitCredentialConfig struct {
	...
	GitUsername *string `field:"required" json:"gitUsername" yaml:"gitUsername"`
	...
	PersonalAccessToken *string `field:"required" json:"personalAccessToken" yaml:"personalAccessToken"`
