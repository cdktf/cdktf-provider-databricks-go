...
func (d *jsiiProxy_DataDatabricksDatabaseInstanceChildInstanceRefsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksDatabaseInstanceChildInstanceRefsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
