...
func (j *jsiiProxy_DataQualityMonitorDataProfilingConfigCustomMetricsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataQualityMonitorDataProfilingConfigCustomMetricsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataQualityMonitorDataProfilingConfigCustomMetricsList {
	_init_.Initialize()
...
func NewDataQualityMonitorDataProfilingConfigCustomMetricsList_Override(d DataQualityMonitorDataProfilingConfigCustomMetricsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataQualityMonitorDataProfilingConfigCustomMetricsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataQualityMonitorDataProfilingConfigCustomMetricsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataQualityMonitorDataProfilingConfigCustomMetricsList) Resolve(_context cdktf.IResolveContext) interface{} {
