...
func (m *jsiiProxy_MwsCustomerManagedKeysAwsKeyInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MwsCustomerManagedKeysAwsKeyInfoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
