...
type DataDatabricksCleanRoomAssetRevisionsCleanRoomAssetsRevisionsTableColumns struct {
	...
	Mask *DataDatabricksCleanRoomAssetRevisionsCleanRoomAssetsRevisionsTableColumnsMask `field:"optional" json:"mask" yaml:"mask"`
