...
import (
	...
	"github.com/hashicorp/cdktf-provider-databricks-go/databricks/v3/datadatabricksawsassumerolepolicy/internal"
...
func (j *jsiiProxy_DataDatabricksAwsAssumeRolePolicy) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
