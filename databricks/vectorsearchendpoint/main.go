...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "effectiveBudgetPolicyIdInput", GoGetter: "EffectiveBudgetPolicyIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEffectiveBudgetPolicyId", GoMethod: "ResetEffectiveBudgetPolicyId"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-databricks.vectorSearchEndpoint.VectorSearchEndpointCustomTags",
		reflect.TypeOf((*VectorSearchEndpointCustomTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-databricks.vectorSearchEndpoint.VectorSearchEndpointCustomTagsList",
		reflect.TypeOf((*VectorSearchEndpointCustomTagsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*VectorSearchEndpointCustomTagsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
