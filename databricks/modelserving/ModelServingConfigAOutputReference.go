...
func (m *jsiiProxy_ModelServingConfigAOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ModelServingConfigAOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
