...
func (m *jsiiProxy_ModelServing) validatePutRateLimitsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ModelServingRateLimits; received %#v (a %T)", value, value)
		}
	}
...
func (m *jsiiProxy_ModelServing) validatePutTagsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ModelServingTags; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_ModelServing) validateSetLifecycleParameters(val *cdktf.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
