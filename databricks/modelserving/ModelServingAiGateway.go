...
type ModelServingAiGateway struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.92.0/docs/resources/model_serving#fallback_config ModelServing#fallback_config}
	FallbackConfig *ModelServingAiGatewayFallbackConfig `field:"optional" json:"fallbackConfig" yaml:"fallbackConfig"`
	// guardrails block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.92.0/docs/resources/model_serving#guardrails ModelServing#guardrails}
	Guardrails *ModelServingAiGatewayGuardrails `field:"optional" json:"guardrails" yaml:"guardrails"`
	// inference_table_config block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.92.0/docs/resources/model_serving#inference_table_config ModelServing#inference_table_config}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.92.0/docs/resources/model_serving#usage_tracking_config ModelServing#usage_tracking_config}
