...
func (m *jsiiProxy_ModelServingAiGatewayOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ModelServingAiGatewayOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
