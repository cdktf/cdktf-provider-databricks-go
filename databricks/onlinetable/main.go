...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTableServingUrl", GoMethod: "ResetTableServingUrl"},
			...
			_jsii_.MemberProperty{JsiiProperty: "tableServingUrlInput", GoGetter: "TableServingUrlInput"},
