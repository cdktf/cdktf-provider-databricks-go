...
func (j *jsiiProxy_VectorSearchIndexStatusList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewVectorSearchIndexStatusList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VectorSearchIndexStatusList {
	_init_.Initialize()
...
func NewVectorSearchIndexStatusList_Override(v VectorSearchIndexStatusList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VectorSearchIndexStatusList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (v *jsiiProxy_VectorSearchIndexStatusList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VectorSearchIndexStatusList) Resolve(_context cdktf.IResolveContext) interface{} {
