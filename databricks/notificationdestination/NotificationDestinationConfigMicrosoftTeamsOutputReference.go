...
import (
	...
	"github.com/cdktf/cdktf-provider-databricks-go/databricks/v13/notificationdestination/internal"
...
func (n *jsiiProxy_NotificationDestinationConfigMicrosoftTeamsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NotificationDestinationConfigMicrosoftTeamsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
