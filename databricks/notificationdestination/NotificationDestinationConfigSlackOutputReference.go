...
func (n *jsiiProxy_NotificationDestinationConfigSlackOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NotificationDestinationConfigSlackOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
