...
func (j *jsiiProxy_WorkspaceSettingV2EffectiveAibiDashboardEmbeddingAccessPolicyOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *WorkspaceSettingV2EffectiveAibiDashboardEmbeddingAccessPolicy; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_WorkspaceSettingV2EffectiveAibiDashboardEmbeddingAccessPolicyOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewWorkspaceSettingV2EffectiveAibiDashboardEmbeddingAccessPolicyOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) error {
