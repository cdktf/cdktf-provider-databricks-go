...
import (
	...
	"github.com/hashicorp/cdktf-provider-databricks-go/databricks/v3/userrole/internal"
...
func (j *jsiiProxy_UserRole) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_UserRole)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
