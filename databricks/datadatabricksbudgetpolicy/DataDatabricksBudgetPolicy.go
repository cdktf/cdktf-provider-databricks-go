...
import (
	...
	"github.com/cdktf/cdktf-provider-databricks-go/databricks/v15/datadatabricksbudgetpolicy/internal"
...
func (j *jsiiProxy_DataDatabricksBudgetPolicy) CustomTagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"customTagsInput",
...
func (j *jsiiProxy_DataDatabricksBudgetPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataDatabricksBudgetPolicy) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataDatabricksBudgetPolicy) PolicyNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"policyNameInput",
...
func (j *jsiiProxy_DataDatabricksBudgetPolicy) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataDatabricksBudgetPolicy) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataDatabricksBudgetPolicy)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataDatabricksBudgetPolicy)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataDatabricksBudgetPolicy)SetPolicyName(val *string) {
...
func (j *jsiiProxy_DataDatabricksBudgetPolicy)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataDatabricksBudgetPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataDatabricksBudgetPolicy) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksBudgetPolicy) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksBudgetPolicy) PutCustomTags(value interface{}) {
...
func (d *jsiiProxy_DataDatabricksBudgetPolicy) ResetCustomTags() {
	_jsii_.InvokeVoid(
		d,
		"resetCustomTags",
		nil, // no parameters
...
func (d *jsiiProxy_DataDatabricksBudgetPolicy) ResetPolicyName() {
	_jsii_.InvokeVoid(
		d,
		"resetPolicyName",
		nil, // no parameters
