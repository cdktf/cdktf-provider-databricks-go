...
type DataDatabricksJobJobSettingsSettingsTrigger struct {
	// file_arrival block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.81.1/docs/data-sources/job#file_arrival DataDatabricksJob#file_arrival}
	...
	// periodic block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.81.1/docs/data-sources/job#periodic DataDatabricksJob#periodic}
	Periodic *DataDatabricksJobJobSettingsSettingsTriggerPeriodic `field:"optional" json:"periodic" yaml:"periodic"`
	// table_update block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.81.1/docs/data-sources/job#table_update DataDatabricksJob#table_update}
