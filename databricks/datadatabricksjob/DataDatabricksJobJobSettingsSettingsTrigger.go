...
type DataDatabricksJobJobSettingsSettingsTrigger struct {
	// file_arrival block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.17.0/docs/data-sources/job#file_arrival DataDatabricksJob#file_arrival}
