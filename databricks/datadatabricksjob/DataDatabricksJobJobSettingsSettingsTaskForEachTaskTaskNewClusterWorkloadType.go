...
type DataDatabricksJobJobSettingsSettingsTaskForEachTaskTaskNewClusterWorkloadType struct {
	// clients block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.60.0/docs/data-sources/job#clients DataDatabricksJob#clients}
