...
type DataDatabricksJobJobSettingsSettingsTaskNewClusterDockerImage struct {
	...
	// basic_auth block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.73.0/docs/data-sources/job#basic_auth DataDatabricksJob#basic_auth}
