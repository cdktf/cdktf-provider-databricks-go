...
func (d *jsiiProxy_DataDatabricksJobJobSettingsSettingsTaskForEachTaskTaskOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksJobJobSettingsSettingsTaskForEachTaskTaskOutputReference) ResetTaskKey() {
	_jsii_.InvokeVoid(
		d,
		"resetTaskKey",
		nil, // no parameters
...
func (d *jsiiProxy_DataDatabricksJobJobSettingsSettingsTaskForEachTaskTaskOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
