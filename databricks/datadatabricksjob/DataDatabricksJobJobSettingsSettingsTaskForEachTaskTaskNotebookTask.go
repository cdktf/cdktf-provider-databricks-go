...
type DataDatabricksJobJobSettingsSettingsTaskForEachTaskTaskNotebookTask struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.50.0/docs/data-sources/job#notebook_path DataDatabricksJob#notebook_path}.
	NotebookPath *string `field:"required" json:"notebookPath" yaml:"notebookPath"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.50.0/docs/data-sources/job#base_parameters DataDatabricksJob#base_parameters}.
