...
func (d *jsiiProxy_DataDatabricksJobJobSettingsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksJobJobSettingsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
