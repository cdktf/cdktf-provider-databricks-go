...
func (d *jsiiProxy_DataDatabricksJobJobSettingsSettingsTaskSqlTaskAlertSubscriptionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatabricksJobJobSettingsSettingsTaskSqlTaskAlertSubscriptionsList) Resolve(context cdktf.IResolveContext) interface{} {
