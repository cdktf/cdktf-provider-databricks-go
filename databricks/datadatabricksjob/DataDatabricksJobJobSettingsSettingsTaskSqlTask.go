...
type DataDatabricksJobJobSettingsSettingsTaskSqlTask struct {
	...
	// alert block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.81.0/docs/data-sources/job#alert DataDatabricksJob#alert}
	Alert *DataDatabricksJobJobSettingsSettingsTaskSqlTaskAlert `field:"optional" json:"alert" yaml:"alert"`
	// dashboard block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.81.0/docs/data-sources/job#dashboard DataDatabricksJob#dashboard}
	...
	// query block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.81.0/docs/data-sources/job#query DataDatabricksJob#query}
