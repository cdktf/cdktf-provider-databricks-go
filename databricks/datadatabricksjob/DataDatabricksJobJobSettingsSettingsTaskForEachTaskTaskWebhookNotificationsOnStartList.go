...
func (d *jsiiProxy_DataDatabricksJobJobSettingsSettingsTaskForEachTaskTaskWebhookNotificationsOnStartList) Resolve(context cdktf.IResolveContext) interface{} {
