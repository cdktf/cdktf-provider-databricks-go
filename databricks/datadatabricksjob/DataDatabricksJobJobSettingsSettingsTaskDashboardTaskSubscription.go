...
type DataDatabricksJobJobSettingsSettingsTaskDashboardTaskSubscription struct {
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.76.0/docs/data-sources/job#paused DataDatabricksJob#paused}.
	Paused interface{} `field:"optional" json:"paused" yaml:"paused"`
	// subscribers block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.76.0/docs/data-sources/job#subscribers DataDatabricksJob#subscribers}
