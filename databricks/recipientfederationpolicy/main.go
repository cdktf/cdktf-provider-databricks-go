...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*RecipientFederationPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-databricks.recipientFederationPolicy.RecipientFederationPolicyConfig",
		reflect.TypeOf((*RecipientFederationPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-databricks.recipientFederationPolicy.RecipientFederationPolicyOidcPolicy",
		reflect.TypeOf((*RecipientFederationPolicyOidcPolicy)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-databricks.recipientFederationPolicy.RecipientFederationPolicyOidcPolicyOutputReference",
		reflect.TypeOf((*RecipientFederationPolicyOidcPolicyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
