...
func (l *jsiiProxy_LakehouseMonitorInferenceLogOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LakehouseMonitorInferenceLogOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
