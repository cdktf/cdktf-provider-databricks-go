...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetInputColumns", GoMethod: "ResetInputColumns"},
			_jsii_.MemberMethod{JsiiMethod: "resetName", GoMethod: "ResetName"},
			_jsii_.MemberMethod{JsiiMethod: "resetOutputDataType", GoMethod: "ResetOutputDataType"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetGranularities", GoMethod: "ResetGranularities"},
			_jsii_.MemberMethod{JsiiMethod: "resetLabelCol", GoMethod: "ResetLabelCol"},
			_jsii_.MemberMethod{JsiiMethod: "resetModelIdCol", GoMethod: "ResetModelIdCol"},
			_jsii_.MemberMethod{JsiiMethod: "resetPredictionCol", GoMethod: "ResetPredictionCol"},
			_jsii_.MemberMethod{JsiiMethod: "resetPredictionProbaCol", GoMethod: "ResetPredictionProbaCol"},
			_jsii_.MemberMethod{JsiiMethod: "resetProblemType", GoMethod: "ResetProblemType"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimestampCol", GoMethod: "ResetTimestampCol"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetQuartzCronExpression", GoMethod: "ResetQuartzCronExpression"},
