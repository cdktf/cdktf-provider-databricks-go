...
type DataDatabricksCleanRoomAssetsAssetsTableColumns struct {
	...
	Mask *DataDatabricksCleanRoomAssetsAssetsTableColumnsMask `field:"optional" json:"mask" yaml:"mask"`
