...
func (d *jsiiProxy_DataDatabricksInstancePoolPoolInfoStatsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksInstancePoolPoolInfoStatsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
