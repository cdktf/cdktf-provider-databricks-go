...
type DataDatabricksCleanRoomAssetRevisionsCleanRoomAssetViewColumns struct {
	...
	Mask *DataDatabricksCleanRoomAssetRevisionsCleanRoomAssetViewColumnsMask `field:"optional" json:"mask" yaml:"mask"`
