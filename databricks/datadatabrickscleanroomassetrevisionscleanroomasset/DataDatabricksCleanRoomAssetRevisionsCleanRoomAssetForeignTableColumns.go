...
type DataDatabricksCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumns struct {
	...
	Mask *DataDatabricksCleanRoomAssetRevisionsCleanRoomAssetForeignTableColumnsMask `field:"optional" json:"mask" yaml:"mask"`
