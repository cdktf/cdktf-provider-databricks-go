...
func (j *jsiiProxy_SharePluginframeworkObjectOutputReference) EffectiveCdfEnabled() cdktf.IResolvable {
...
func (j *jsiiProxy_SharePluginframeworkObjectOutputReference) EffectiveStringSharedAs() *string {
	var returns *string
	_jsii_.Get(
		j,
