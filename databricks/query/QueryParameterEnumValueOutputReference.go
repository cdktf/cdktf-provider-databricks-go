...
func (q *jsiiProxy_QueryParameterEnumValueOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (q *jsiiProxy_QueryParameterEnumValueOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
