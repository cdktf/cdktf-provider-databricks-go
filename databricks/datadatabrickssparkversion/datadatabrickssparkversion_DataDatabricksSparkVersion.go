...
import (
	...
	"github.com/hashicorp/cdktf-provider-databricks-go/databricks/v3/datadatabrickssparkversion/internal"
...
func (j *jsiiProxy_DataDatabricksSparkVersion) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
