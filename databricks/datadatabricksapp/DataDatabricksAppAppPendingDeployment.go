...
type DataDatabricksAppAppPendingDeployment struct {
	...
	DeploymentArtifacts *DataDatabricksAppAppPendingDeploymentDeploymentArtifacts `field:"optional" json:"deploymentArtifacts" yaml:"deploymentArtifacts"`
	...
	Status *DataDatabricksAppAppPendingDeploymentStatus `field:"optional" json:"status" yaml:"status"`
