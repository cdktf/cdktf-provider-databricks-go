...
func (d *jsiiProxy_DataDatabricksAppAppPendingDeploymentOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksAppAppPendingDeploymentOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
