...
func (a *jsiiProxy_AlertV2EvaluationThresholdValueOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AlertV2EvaluationThresholdValueOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
