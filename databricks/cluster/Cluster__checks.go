...
func (c *jsiiProxy_Cluster) validatePutClusterMountInfoParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ClusterClusterMountInfo; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_Cluster) validatePutInitScriptsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ClusterInitScripts; received %#v (a %T)", value, value)
		}
	}
...
func (c *jsiiProxy_Cluster) validatePutLibraryParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ClusterLibrary; received %#v (a %T)", value, value)
		}
	}
