...
func (c *jsiiProxy_ClusterLibraryMavenOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ClusterLibraryMavenOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
