...
func (c *jsiiProxy_ClusterClusterLogConfOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ClusterClusterLogConfOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
