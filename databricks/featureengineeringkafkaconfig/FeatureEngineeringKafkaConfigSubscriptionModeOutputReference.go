...
func (j *jsiiProxy_FeatureEngineeringKafkaConfigSubscriptionModeOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewFeatureEngineeringKafkaConfigSubscriptionModeOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) FeatureEngineeringKafkaConfigSubscriptionModeOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-databricks.featureEngineeringKafkaConfig.FeatureEngineeringKafkaConfigSubscriptionModeOutputReference",
...
func NewFeatureEngineeringKafkaConfigSubscriptionModeOutputReference_Override(f FeatureEngineeringKafkaConfigSubscriptionModeOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_FeatureEngineeringKafkaConfigSubscriptionModeOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (f *jsiiProxy_FeatureEngineeringKafkaConfigSubscriptionModeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FeatureEngineeringKafkaConfigSubscriptionModeOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (f *jsiiProxy_FeatureEngineeringKafkaConfigSubscriptionModeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FeatureEngineeringKafkaConfigSubscriptionModeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
