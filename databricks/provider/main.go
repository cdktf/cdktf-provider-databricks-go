...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "bricksCliPath", GoGetter: "BricksCliPath"},
			_jsii_.MemberProperty{JsiiProperty: "bricksCliPathInput", GoGetter: "BricksCliPathInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetBricksCliPath", GoMethod: "ResetBricksCliPath"},
