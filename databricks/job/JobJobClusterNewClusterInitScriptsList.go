...
func (j *jsiiProxy_JobJobClusterNewClusterInitScriptsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (j *jsiiProxy_JobJobClusterNewClusterInitScriptsList) Resolve(context cdktf.IResolveContext) interface{} {
