...
func (j *jsiiProxy_JobTaskForEachTaskTaskGenAiComputeTaskComputeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTaskForEachTaskTaskGenAiComputeTaskComputeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
