...
func (j *jsiiProxy_JobJobClusterNewClusterAzureAttributesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobJobClusterNewClusterAzureAttributesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
