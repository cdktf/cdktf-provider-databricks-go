...
func (j *jsiiProxy_JobTaskLibraryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTaskLibraryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
