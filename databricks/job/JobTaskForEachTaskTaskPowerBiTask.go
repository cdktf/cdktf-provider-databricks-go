...
type JobTaskForEachTaskTaskPowerBiTask struct {
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.85.0/docs/resources/job#connection_resource_name Job#connection_resource_name}.
	ConnectionResourceName *string `field:"optional" json:"connectionResourceName" yaml:"connectionResourceName"`
	// power_bi_model block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.85.0/docs/resources/job#power_bi_model Job#power_bi_model}
	PowerBiModel *JobTaskForEachTaskTaskPowerBiTaskPowerBiModel `field:"optional" json:"powerBiModel" yaml:"powerBiModel"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.85.0/docs/resources/job#refresh_after_update Job#refresh_after_update}.
	RefreshAfterUpdate interface{} `field:"optional" json:"refreshAfterUpdate" yaml:"refreshAfterUpdate"`
	// tables block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.85.0/docs/resources/job#tables Job#tables}
