...
func (j *jsiiProxy_JobTaskForEachTaskTaskEmailNotificationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTaskForEachTaskTaskEmailNotificationsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
