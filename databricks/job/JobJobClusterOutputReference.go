...
func (j *jsiiProxy_JobJobClusterOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobJobClusterOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
