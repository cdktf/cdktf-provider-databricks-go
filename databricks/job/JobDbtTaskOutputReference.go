...
func (j *jsiiProxy_JobDbtTaskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobDbtTaskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
