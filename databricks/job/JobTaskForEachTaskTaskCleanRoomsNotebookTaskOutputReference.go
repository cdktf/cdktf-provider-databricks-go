...
func (j *jsiiProxy_JobTaskForEachTaskTaskCleanRoomsNotebookTaskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTaskForEachTaskTaskCleanRoomsNotebookTaskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
