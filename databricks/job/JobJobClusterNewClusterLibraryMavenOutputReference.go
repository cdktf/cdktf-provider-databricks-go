...
func (j *jsiiProxy_JobJobClusterNewClusterLibraryMavenOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobJobClusterNewClusterLibraryMavenOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
