...
func (j *jsiiProxy_JobTaskForEachTaskTaskSqlTaskOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTaskForEachTaskTaskSqlTaskOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
