...
func (j *jsiiProxy_JobGitSourceJobSourceOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobGitSourceJobSourceOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
