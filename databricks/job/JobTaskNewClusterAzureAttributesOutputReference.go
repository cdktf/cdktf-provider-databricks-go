...
func (j *jsiiProxy_JobTaskNewClusterAzureAttributesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTaskNewClusterAzureAttributesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
