...
func (j *jsiiProxy_JobTaskNewClusterAzureAttributesLogAnalyticsInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTaskNewClusterAzureAttributesLogAnalyticsInfoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
