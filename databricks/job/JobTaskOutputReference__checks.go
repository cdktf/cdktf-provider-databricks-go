...
func (j *jsiiProxy_JobTaskOutputReference) validatePutDependsOnParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*JobTaskDependsOn; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_JobTaskOutputReference) validatePutLibraryParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*JobTaskLibrary; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_JobTaskOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *JobTask; received %#v (a %T)", val, val)
		}
	}
