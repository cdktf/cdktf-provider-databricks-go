...
func (j *jsiiProxy_JobTaskPipelineTaskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTaskPipelineTaskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
