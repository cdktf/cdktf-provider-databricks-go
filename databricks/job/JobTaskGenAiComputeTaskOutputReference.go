...
func (j *jsiiProxy_JobTaskGenAiComputeTaskOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTaskGenAiComputeTaskOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
