...
func (j *jsiiProxy_JobTaskGenAiComputeTaskComputeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTaskGenAiComputeTaskComputeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
