...
func (j *jsiiProxy_JobTaskDbtTaskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTaskDbtTaskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
