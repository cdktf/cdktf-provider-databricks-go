...
type JobTaskPowerBiTask struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.86.0/docs/resources/job#power_bi_model Job#power_bi_model}
	PowerBiModel *JobTaskPowerBiTaskPowerBiModel `field:"optional" json:"powerBiModel" yaml:"powerBiModel"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.86.0/docs/resources/job#refresh_after_update Job#refresh_after_update}.
	RefreshAfterUpdate interface{} `field:"optional" json:"refreshAfterUpdate" yaml:"refreshAfterUpdate"`
	// tables block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.86.0/docs/resources/job#tables Job#tables}
