...
func (j *jsiiProxy_JobTaskForEachTaskTaskPythonWheelTaskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTaskForEachTaskTaskPythonWheelTaskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
