...
func (j *jsiiProxy_JobTriggerTableUpdateOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTriggerTableUpdateOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
