...
func (j *jsiiProxy_JobTaskNewClusterLibraryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTaskNewClusterLibraryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
