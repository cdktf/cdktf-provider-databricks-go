...
func (j *jsiiProxy_JobTaskPowerBiTaskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTaskPowerBiTaskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
