...
func (j *jsiiProxy_JobTaskForEachTaskTaskConditionTaskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTaskForEachTaskTaskConditionTaskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
