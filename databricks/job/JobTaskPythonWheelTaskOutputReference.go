...
func (j *jsiiProxy_JobTaskPythonWheelTaskOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTaskPythonWheelTaskOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
