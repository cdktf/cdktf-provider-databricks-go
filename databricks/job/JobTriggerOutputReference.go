...
func (j *jsiiProxy_JobTriggerOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTriggerOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
