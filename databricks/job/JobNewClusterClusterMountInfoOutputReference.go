...
func (j *jsiiProxy_JobNewClusterClusterMountInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobNewClusterClusterMountInfoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
