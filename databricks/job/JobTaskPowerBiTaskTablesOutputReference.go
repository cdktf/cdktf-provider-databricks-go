...
func (j *jsiiProxy_JobTaskPowerBiTaskTablesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTaskPowerBiTaskTablesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
