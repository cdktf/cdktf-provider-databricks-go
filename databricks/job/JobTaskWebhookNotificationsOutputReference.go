...
func (j *jsiiProxy_JobTaskWebhookNotificationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTaskWebhookNotificationsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
