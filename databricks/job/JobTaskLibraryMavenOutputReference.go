...
func (j *jsiiProxy_JobTaskLibraryMavenOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobTaskLibraryMavenOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
