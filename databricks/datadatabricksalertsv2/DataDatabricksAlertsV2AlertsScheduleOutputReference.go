...
func (j *jsiiProxy_DataDatabricksAlertsV2AlertsScheduleOutputReference) InternalValue() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"internalValue",
...
func (j *jsiiProxy_DataDatabricksAlertsV2AlertsScheduleOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataDatabricksAlertsV2AlertsScheduleOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataDatabricksAlertsV2AlertsScheduleOutputReference {
	_init_.Initialize()
...
func NewDataDatabricksAlertsV2AlertsScheduleOutputReference_Override(d DataDatabricksAlertsV2AlertsScheduleOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataDatabricksAlertsV2AlertsScheduleOutputReference)SetInternalValue(val interface{}) {
...
func (j *jsiiProxy_DataDatabricksAlertsV2AlertsScheduleOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataDatabricksAlertsV2AlertsScheduleOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksAlertsV2AlertsScheduleOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (d *jsiiProxy_DataDatabricksAlertsV2AlertsScheduleOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksAlertsV2AlertsScheduleOutputReference) ResetQuartzCronSchedule() {
	_jsii_.InvokeVoid(
		d,
		"resetQuartzCronSchedule",
		nil, // no parameters
...
func (d *jsiiProxy_DataDatabricksAlertsV2AlertsScheduleOutputReference) ResetTimezoneId() {
	_jsii_.InvokeVoid(
		d,
		"resetTimezoneId",
		nil, // no parameters
...
func (d *jsiiProxy_DataDatabricksAlertsV2AlertsScheduleOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
