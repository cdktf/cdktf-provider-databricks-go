...
// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.48.2/docs/data-sources/share databricks_share}.
...
func (j *jsiiProxy_DataDatabricksShare) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataDatabricksShare) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataDatabricksShare) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataDatabricksShare) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.48.2/docs/data-sources/share databricks_share} Data Source.
...
func (j *jsiiProxy_DataDatabricksShare)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataDatabricksShare)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func DataDatabricksShare_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataDatabricksShare) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksShare) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
