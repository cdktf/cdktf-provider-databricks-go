...
func (j *jsiiProxy_DataDatabricksRfaAccessRequestDestinationsDestinationsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataDatabricksRfaAccessRequestDestinationsDestinationsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataDatabricksRfaAccessRequestDestinationsDestinationsOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"@cdktf/provider-databricks.dataDatabricksRfaAccessRequestDestinations.DataDatabricksRfaAccessRequestDestinationsDestinationsOutputReference",
...
func NewDataDatabricksRfaAccessRequestDestinationsDestinationsOutputReference_Override(d DataDatabricksRfaAccessRequestDestinationsDestinationsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataDatabricksRfaAccessRequestDestinationsDestinationsOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataDatabricksRfaAccessRequestDestinationsDestinationsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksRfaAccessRequestDestinationsDestinationsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (d *jsiiProxy_DataDatabricksRfaAccessRequestDestinationsDestinationsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksRfaAccessRequestDestinationsDestinationsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
