...
func (d *jsiiProxy_DataDatabricksNotebookPathsNotebookPathListStructList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatabricksNotebookPathsNotebookPathListStructList) Resolve(context cdktf.IResolveContext) interface{} {
