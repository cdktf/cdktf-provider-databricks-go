...
func (r *jsiiProxy_RegisteredModelAliasesOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RegisteredModelAliasesOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
