...
type SqlEndpointConfig struct {
	...
	// timeouts block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.48.1/docs/resources/sql_endpoint#timeouts SqlEndpoint#timeouts}
