...
import (
	...
	"github.com/hashicorp/cdktf-provider-databricks-go/databricks/v3/recipient/internal"
...
func (r *jsiiProxy_RecipientTokensOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
