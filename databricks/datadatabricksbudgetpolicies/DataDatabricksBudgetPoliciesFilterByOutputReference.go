...
func (d *jsiiProxy_DataDatabricksBudgetPoliciesFilterByOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksBudgetPoliciesFilterByOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
