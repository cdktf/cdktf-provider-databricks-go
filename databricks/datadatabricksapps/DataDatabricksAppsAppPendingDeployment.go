...
type DataDatabricksAppsAppPendingDeployment struct {
	...
	DeploymentArtifacts *DataDatabricksAppsAppPendingDeploymentDeploymentArtifacts `field:"optional" json:"deploymentArtifacts" yaml:"deploymentArtifacts"`
	...
	Status *DataDatabricksAppsAppPendingDeploymentStatus `field:"optional" json:"status" yaml:"status"`
