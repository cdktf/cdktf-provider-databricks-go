...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putDeploymentArtifacts", GoMethod: "PutDeploymentArtifacts"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "activeDeploymentInput", GoGetter: "ActiveDeploymentInput"},
			_jsii_.MemberProperty{JsiiProperty: "appStatus", GoGetter: "AppStatus"},
			_jsii_.MemberProperty{JsiiProperty: "appStatusInput", GoGetter: "AppStatusInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "computeStatus", GoGetter: "ComputeStatus"},
			_jsii_.MemberProperty{JsiiProperty: "computeStatusInput", GoGetter: "ComputeStatusInput"},
			_jsii_.MemberProperty{JsiiProperty: "createTime", GoGetter: "CreateTime"},
			_jsii_.MemberProperty{JsiiProperty: "createTimeInput", GoGetter: "CreateTimeInput"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "creator", GoGetter: "Creator"},
			...
			_jsii_.MemberProperty{JsiiProperty: "defaultSourceCodePathInput", GoGetter: "DefaultSourceCodePathInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "pendingDeploymentInput", GoGetter: "PendingDeploymentInput"},
			_jsii_.MemberMethod{JsiiMethod: "putActiveDeployment", GoMethod: "PutActiveDeployment"},
			_jsii_.MemberMethod{JsiiMethod: "putAppStatus", GoMethod: "PutAppStatus"},
			_jsii_.MemberMethod{JsiiMethod: "putComputeStatus", GoMethod: "PutComputeStatus"},
			_jsii_.MemberMethod{JsiiMethod: "putPendingDeployment", GoMethod: "PutPendingDeployment"},
			_jsii_.MemberMethod{JsiiMethod: "putResources", GoMethod: "PutResources"},
			_jsii_.MemberMethod{JsiiMethod: "resetActiveDeployment", GoMethod: "ResetActiveDeployment"},
			_jsii_.MemberMethod{JsiiMethod: "resetAppStatus", GoMethod: "ResetAppStatus"},
			_jsii_.MemberMethod{JsiiMethod: "resetComputeStatus", GoMethod: "ResetComputeStatus"},
			_jsii_.MemberMethod{JsiiMethod: "resetCreateTime", GoMethod: "ResetCreateTime"},
			_jsii_.MemberMethod{JsiiMethod: "resetCreator", GoMethod: "ResetCreator"},
			_jsii_.MemberMethod{JsiiMethod: "resetDefaultSourceCodePath", GoMethod: "ResetDefaultSourceCodePath"},
			_jsii_.MemberMethod{JsiiMethod: "resetDescription", GoMethod: "ResetDescription"},
			_jsii_.MemberMethod{JsiiMethod: "resetPendingDeployment", GoMethod: "ResetPendingDeployment"},
			_jsii_.MemberMethod{JsiiMethod: "resetResources", GoMethod: "ResetResources"},
			_jsii_.MemberMethod{JsiiMethod: "resetServicePrincipalClientId", GoMethod: "ResetServicePrincipalClientId"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetUpdater", GoMethod: "ResetUpdater"},
			_jsii_.MemberMethod{JsiiMethod: "resetUpdateTime", GoMethod: "ResetUpdateTime"},
			...
			_jsii_.MemberProperty{JsiiProperty: "servicePrincipalClientIdInput", GoGetter: "ServicePrincipalClientIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "updaterInput", GoGetter: "UpdaterInput"},
			_jsii_.MemberProperty{JsiiProperty: "updateTime", GoGetter: "UpdateTime"},
			_jsii_.MemberProperty{JsiiProperty: "updateTimeInput", GoGetter: "UpdateTimeInput"},
