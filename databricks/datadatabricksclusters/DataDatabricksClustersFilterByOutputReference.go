...
func (d *jsiiProxy_DataDatabricksClustersFilterByOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksClustersFilterByOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
