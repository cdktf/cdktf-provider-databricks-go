...
func (f *jsiiProxy_FeatureEngineeringMaterializedFeatureOnlineStoreConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FeatureEngineeringMaterializedFeatureOnlineStoreConfigOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
