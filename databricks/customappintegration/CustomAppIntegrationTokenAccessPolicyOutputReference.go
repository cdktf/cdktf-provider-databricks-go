...
func (c *jsiiProxy_CustomAppIntegrationTokenAccessPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CustomAppIntegrationTokenAccessPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
