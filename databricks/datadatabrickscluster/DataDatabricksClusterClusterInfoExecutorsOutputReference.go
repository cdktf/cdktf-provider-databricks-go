...
func (d *jsiiProxy_DataDatabricksClusterClusterInfoExecutorsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksClusterClusterInfoExecutorsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
