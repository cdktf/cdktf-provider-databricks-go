...
type DataDatabricksClusterClusterInfoSpecWorkloadType struct {
	// clients block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.79.0/docs/data-sources/cluster#clients DataDatabricksCluster#clients}
