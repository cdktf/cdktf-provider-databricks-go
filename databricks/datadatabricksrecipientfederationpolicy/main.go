...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatabricksRecipientFederationPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-databricks.dataDatabricksRecipientFederationPolicy.DataDatabricksRecipientFederationPolicyConfig",
		reflect.TypeOf((*DataDatabricksRecipientFederationPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-databricks.dataDatabricksRecipientFederationPolicy.DataDatabricksRecipientFederationPolicyOidcPolicy",
		reflect.TypeOf((*DataDatabricksRecipientFederationPolicyOidcPolicy)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatabricksRecipientFederationPolicyOidcPolicyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
