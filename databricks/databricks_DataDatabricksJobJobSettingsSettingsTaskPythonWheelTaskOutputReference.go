...
func NewDataDatabricksJobJobSettingsSettingsTaskPythonWheelTaskOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) DataDatabricksJobJobSettingsSettingsTaskPythonWheelTaskOutputReference {
	...
	_jsii_.Create(
		"@cdktf/provider-databricks.DataDatabricksJobJobSettingsSettingsTaskPythonWheelTaskOutputReference",
...
func (d *jsiiProxy_DataDatabricksJobJobSettingsSettingsTaskPythonWheelTaskOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksJobJobSettingsSettingsTaskPythonWheelTaskOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
