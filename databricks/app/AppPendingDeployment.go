...
type AppPendingDeployment struct {
	...
	DeploymentArtifacts *AppPendingDeploymentDeploymentArtifacts `field:"optional" json:"deploymentArtifacts" yaml:"deploymentArtifacts"`
	...
	Status *AppPendingDeploymentStatus `field:"optional" json:"status" yaml:"status"`
