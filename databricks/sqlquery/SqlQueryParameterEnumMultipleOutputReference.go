...
func (s *jsiiProxy_SqlQueryParameterEnumMultipleOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SqlQueryParameterEnumMultipleOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
