...
func (s *jsiiProxy_SqlQueryScheduleDailyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SqlQueryScheduleDailyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
