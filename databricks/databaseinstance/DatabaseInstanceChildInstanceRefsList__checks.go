...
func (d *jsiiProxy_DatabaseInstanceChildInstanceRefsList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_DatabaseInstanceChildInstanceRefsList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*DatabaseInstanceChildInstanceRefs; received %#v (a %T)", val, val)
		}
	}
