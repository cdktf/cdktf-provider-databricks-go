...
func (d *jsiiProxy_DataDatabricksExternalLocationExternalLocationInfoFileEventQueueProvidedAqsOutputReference) validateInterpolationForAttributeParameters(terraformAttribute *string) error {
	return nil
}

func (d *jsiiProxy_DataDatabricksExternalLocationExternalLocationInfoFileEventQueueProvidedAqsOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
