...
func (p *jsiiProxy_Pipeline) validatePutClusterParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*PipelineCluster; received %#v (a %T)", value, value)
		}
	}
...
func (p *jsiiProxy_Pipeline) validatePutLibraryParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*PipelineLibrary; received %#v (a %T)", value, value)
		}
	}
...
func (p *jsiiProxy_Pipeline) validatePutNotificationParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*PipelineNotification; received %#v (a %T)", value, value)
		}
	}
