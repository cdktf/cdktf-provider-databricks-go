...
func (p *jsiiProxy_PipelineGatewayDefinitionOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PipelineGatewayDefinitionOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
