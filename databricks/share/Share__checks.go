...
func (s *jsiiProxy_Share) validatePutObjectParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ShareObject; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_Share) validatePutProviderConfigParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ShareProviderConfig; received %#v (a %T)", value, value)
		}
	}
