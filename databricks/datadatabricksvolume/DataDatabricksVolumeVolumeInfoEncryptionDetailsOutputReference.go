...
func (d *jsiiProxy_DataDatabricksVolumeVolumeInfoEncryptionDetailsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksVolumeVolumeInfoEncryptionDetailsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
