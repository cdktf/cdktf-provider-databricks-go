...
func (m *jsiiProxy_ModelServingProvisionedThroughputConfigServedEntitiesOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ModelServingProvisionedThroughputConfigServedEntitiesOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
