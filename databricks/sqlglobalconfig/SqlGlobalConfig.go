...
import (
	...
	"github.com/cdktf/cdktf-provider-databricks-go/databricks/v13/sqlglobalconfig/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.36.2/docs/resources/sql_global_config databricks_sql_global_config}.
...
func (j *jsiiProxy_SqlGlobalConfig) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_SqlGlobalConfig) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SqlGlobalConfig) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SqlGlobalConfig) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_SqlGlobalConfig) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.36.2/docs/resources/sql_global_config databricks_sql_global_config} Resource.
...
func SqlGlobalConfig_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
