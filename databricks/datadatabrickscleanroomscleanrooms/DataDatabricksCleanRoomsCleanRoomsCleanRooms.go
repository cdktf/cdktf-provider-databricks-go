...
type DataDatabricksCleanRoomsCleanRoomsCleanRooms struct {
	...
	RemoteDetailedInfo *DataDatabricksCleanRoomsCleanRoomsCleanRoomsRemoteDetailedInfo `field:"optional" json:"remoteDetailedInfo" yaml:"remoteDetailedInfo"`
}
