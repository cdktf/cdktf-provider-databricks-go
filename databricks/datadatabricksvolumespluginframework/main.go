...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataDatabricksVolumesPluginframework)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-databricks.dataDatabricksVolumesPluginframework.DataDatabricksVolumesPluginframeworkConfig",
		reflect.TypeOf((*DataDatabricksVolumesPluginframeworkConfig)(nil)).Elem(),
	)
}
