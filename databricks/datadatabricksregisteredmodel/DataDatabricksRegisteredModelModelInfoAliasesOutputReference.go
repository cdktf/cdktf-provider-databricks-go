...
func (d *jsiiProxy_DataDatabricksRegisteredModelModelInfoAliasesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksRegisteredModelModelInfoAliasesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
