...
func (a *jsiiProxy_AutomaticClusterUpdateWorkspaceSettingAutomaticClusterUpdateWorkspaceEnablementDetailsList) Resolve(_context cdktf.IResolveContext) interface{} {
