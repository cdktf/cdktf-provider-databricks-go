...
import (
	...
	"github.com/cdktf/cdktf-provider-databricks-go/databricks/v15/grants/internal"
...
func (j *jsiiProxy_GrantsGrantOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGrantsGrantOutputReference_Override(g GrantsGrantOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (g *jsiiProxy_GrantsGrantOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (g *jsiiProxy_GrantsGrantOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GrantsGrantOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
