...
func (j *jsiiProxy_DataDatabricksAccountFederationPoliciesPoliciesOutputReference) ServicePrincipalIdInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataDatabricksAccountFederationPoliciesPoliciesOutputReference)SetServicePrincipalId(val *float64) {
...
func (d *jsiiProxy_DataDatabricksAccountFederationPoliciesPoliciesOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksAccountFederationPoliciesPoliciesOutputReference) ResetPolicyId() {
	_jsii_.InvokeVoid(
		d,
		"resetPolicyId",
		nil, // no parameters
...
func (d *jsiiProxy_DataDatabricksAccountFederationPoliciesPoliciesOutputReference) ResetServicePrincipalId() {
	_jsii_.InvokeVoid(
		d,
		"resetServicePrincipalId",
		nil, // no parameters
