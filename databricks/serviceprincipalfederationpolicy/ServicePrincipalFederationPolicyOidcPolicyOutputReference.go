...
func (s *jsiiProxy_ServicePrincipalFederationPolicyOidcPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServicePrincipalFederationPolicyOidcPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
