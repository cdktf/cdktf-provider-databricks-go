...
func (d *jsiiProxy_DataDatabricksServingEndpointsEndpointsAiGatewayGuardrailsOutputOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (d *jsiiProxy_DataDatabricksServingEndpointsEndpointsAiGatewayGuardrailsOutputOutputReference) validatePutPiiParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*DataDatabricksServingEndpointsEndpointsAiGatewayGuardrailsOutputPii; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DataDatabricksServingEndpointsEndpointsAiGatewayGuardrailsOutputOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_DataDatabricksServingEndpointsEndpointsAiGatewayGuardrailsOutputOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *DataDatabricksServingEndpointsEndpointsAiGatewayGuardrailsOutput; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_DataDatabricksServingEndpointsEndpointsAiGatewayGuardrailsOutputOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewDataDatabricksServingEndpointsEndpointsAiGatewayGuardrailsOutputOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
