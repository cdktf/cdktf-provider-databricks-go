...
func (d *jsiiProxy_DataDatabricksSqlWarehouseHealthOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksSqlWarehouseHealthOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
