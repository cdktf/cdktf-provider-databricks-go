...
type DataDatabricksClusterPluginframeworkClusterInfoClusterLogConf struct {
	...
	Dbfs *DataDatabricksClusterPluginframeworkClusterInfoClusterLogConfDbfs `field:"optional" json:"dbfs" yaml:"dbfs"`
	...
	S3 *DataDatabricksClusterPluginframeworkClusterInfoClusterLogConfS3 `field:"optional" json:"s3" yaml:"s3"`
}
