...
func (j *jsiiProxy_DataDatabricksClusterPluginframeworkClusterInfoSpecClusterLogConfVolumesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataDatabricksClusterPluginframeworkClusterInfoSpecClusterLogConfVolumesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataDatabricksClusterPluginframeworkClusterInfoSpecClusterLogConfVolumesList {
	_init_.Initialize()
...
func NewDataDatabricksClusterPluginframeworkClusterInfoSpecClusterLogConfVolumesList_Override(d DataDatabricksClusterPluginframeworkClusterInfoSpecClusterLogConfVolumesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataDatabricksClusterPluginframeworkClusterInfoSpecClusterLogConfVolumesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataDatabricksClusterPluginframeworkClusterInfoSpecClusterLogConfVolumesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataDatabricksClusterPluginframeworkClusterInfoSpecClusterLogConfVolumesList) Resolve(_context cdktf.IResolveContext) interface{} {
