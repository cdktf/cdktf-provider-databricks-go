...
func (d *jsiiProxy_DataDatabricksFunctionsFunctionsRoutineDependenciesDependenciesOutputReference) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
