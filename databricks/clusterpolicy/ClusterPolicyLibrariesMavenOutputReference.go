...
func (c *jsiiProxy_ClusterPolicyLibrariesMavenOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ClusterPolicyLibrariesMavenOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
