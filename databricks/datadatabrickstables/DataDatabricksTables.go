...
import (
	...
	"github.com/cdktf/cdktf-provider-databricks-go/databricks/v13/datadatabrickstables/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.36.2/docs/data-sources/tables databricks_tables}.
...
func (j *jsiiProxy_DataDatabricksTables) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataDatabricksTables) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataDatabricksTables) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataDatabricksTables) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataDatabricksTables) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.36.2/docs/data-sources/tables databricks_tables} Data Source.
...
func (j *jsiiProxy_DataDatabricksTables)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataDatabricksTables)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataDatabricksTables)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataDatabricksTables_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataDatabricksTables) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksTables) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
