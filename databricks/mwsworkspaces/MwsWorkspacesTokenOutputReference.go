...
func (m *jsiiProxy_MwsWorkspacesTokenOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MwsWorkspacesTokenOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
