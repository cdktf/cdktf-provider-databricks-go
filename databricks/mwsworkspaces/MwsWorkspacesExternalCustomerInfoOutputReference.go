...
func (m *jsiiProxy_MwsWorkspacesExternalCustomerInfoOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_MwsWorkspacesExternalCustomerInfoOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
