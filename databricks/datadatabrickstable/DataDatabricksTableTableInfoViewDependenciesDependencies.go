...
type DataDatabricksTableTableInfoViewDependenciesDependencies struct {
	// function block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.72.0/docs/data-sources/table#function DataDatabricksTable#function}
	Function *DataDatabricksTableTableInfoViewDependenciesDependenciesFunction `field:"optional" json:"function" yaml:"function"`
	// table block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.72.0/docs/data-sources/table#table DataDatabricksTable#table}
