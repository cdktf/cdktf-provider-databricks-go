...
type DataDatabricksTableTableInfoTableConstraintsForeignKeyConstraint struct {
	...
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.66.0/docs/data-sources/table#parent_columns DataDatabricksTable#parent_columns}.
	ParentColumns *[]*string `field:"required" json:"parentColumns" yaml:"parentColumns"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.66.0/docs/data-sources/table#parent_table DataDatabricksTable#parent_table}.
