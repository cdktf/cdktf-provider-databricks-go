...
func (d *jsiiProxy_DataDatabricksTableTableInfoColumnsMaskOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataDatabricksTableTableInfoColumnsMaskOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
