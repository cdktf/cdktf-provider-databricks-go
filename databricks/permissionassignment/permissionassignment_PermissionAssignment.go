...
import (
	...
	"github.com/hashicorp/cdktf-provider-databricks-go/databricks/v3/permissionassignment/internal"
...
func (j *jsiiProxy_PermissionAssignment) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_PermissionAssignment)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
